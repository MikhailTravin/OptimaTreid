(() => {
    ...
    function formQuantityProduct() {
        ...
        if (arrowsBlock) arrowsBlock.addEventListener("click", (e => {
            ...
            if (target.classList.contains("quantity__button_plus")) ++value; else if (target.classList.contains("quantity__button_minus")) --value;
    ...
    function formQuantityConsumables() {
        const arrowsBlockConsumables = document.querySelector(".quantity-consumables-content");
        const minusBtnConsumables = document.querySelector(".quantity-consumables__button_minus");
        const inputConsumables = document.querySelector(".quantity-consumables__input input");
        if (arrowsBlockConsumables) arrowsBlockConsumables.addEventListener("click", (e => {
            const target = e.target;
            let value = Number(inputConsumables.value);
            if (target.classList.contains("quantity-consumables__button_plus")) ++value; else if (target.classList.contains("quantity-consumables__button_minus")) --value;
            minusBtnConsumables.classList.remove("disabled");
            if (value <= 0) {
                value = 0;
                minusBtnConsumables.classList.add("disabled");
            }
            inputConsumables.value = value;
        }));
    }
    formQuantityProduct();
