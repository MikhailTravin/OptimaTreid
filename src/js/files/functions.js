...
export function tabs() {
	...
	*/
	...
	/*
	function tabsSpoller() {
		let tabsTitlesSpoller = querySelectorAll('.tabs__title');
		if (tabs.classList.contains('_tab-spoller')) {
			tabsTitlesSpoller.classList.remove('_tab-active');
		}
	}
	*/
}
...
export function menuOpen() {
	...
	menuShadow.classList.add("_active");
}
